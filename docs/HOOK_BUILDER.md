...
Module percentages together cannot exceed 100% of the creator's 70% share. Protocol allocation is always 30%, computed before modules. The UI separately displays token-fee and USDC-fee routing because not every module spends both currencies. Modules never spend other tokens' reserves, creator claim balances or treasury claims.
